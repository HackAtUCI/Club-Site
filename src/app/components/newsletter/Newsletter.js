...
function Newsletter(props) {
    return (
        <div id="newsletter" className="jumbotron jumbotron-fluid newsletter" style={props.style}>
            <div className="container text-left newsletter-container">
                <h1 className="newsletter-left"><b>Subscribe to our newsletter!</b></h1>
                <div className="newsletter-left">
                    <p className="newsletter-info">Get Involved! By filling your information and clicking "Subscribe", Hack at UCI will send you
                        emails about the club's updates and events. </p>
                    <p className="newsletter-mailchimp-info">Some text that we have to put here about Mailchimp's terms of service or something like that.</p>
                </div>
