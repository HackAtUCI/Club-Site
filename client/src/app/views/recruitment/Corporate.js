...
function Corporate() {
	return (
		<>
			...
			<p>
				<strong>Hackathon specialist:</strong> Attend other hackathons (LA
			...
			<p>
				<strong>Career specialist:</strong> Attend and volunteer at UCI career
			...
			<ul>
				...
				<li>Proficient in managing information through spreadsheets</li>
