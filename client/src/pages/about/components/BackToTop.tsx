...
export default function BackToTop() {
  ...
  return (
    ...
    >
        <div className="flex flex-col z-50 rounded-[40px] p-6 bg-gradient-to-b from-[#ECEFFD] to-[#B7C2F3] cursor-pointer" onClick={scrollToTop}>
            <button
                onClick={scrollToTop}
            ...
            >
                <h1 className="text-2xl md:text-4xl font-bold bg-gradient-to-b from-[#2D2D3E] via-[#2D2D3E] to-[#4D4D70E5] bg-clip-text text-transparent ">
                    Back to the top
                </h1>
            </button>
        </div>
