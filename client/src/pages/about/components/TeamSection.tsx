				...
				<div className="flex flex-col gap-16 rounded-[40px] px-10 py-16 bg-gradient-to-b from-[#ECEFFD] to-[#B7C2F3]">
					...
					{Object.entries(teamMembers).map(
						([teamName, members]: [string, TeamMember[]]) => (
							<section key={teamName} className="w-full p-10 rounded-[40px] border border-white/10 bg-white/20 backdrop-blur-lg shadow-[0_3px_3px_0px_#00000040,inset_0_3px_3px_0px_#00000040]">
